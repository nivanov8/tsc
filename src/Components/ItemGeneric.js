                    ...
                    <div class="row" style={{margin: "0em 0em 2em 4em"}}>
                        ...
                        <div class="col-lg-4" style={{margin: "5em 0em 2em 3em"}}>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="inputUsername" placeholder="Quantity"></input>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <Link to="/" class="btn btn-primary btn-lg" style={{margin: "3em 2em 2em 7em"}}>Add to Cart</Link>
                            </div>
